...
// --------- Machines ---------
// GET machines avec filtres:
//   atelierId (obligatoire pour ton cas d’usage)
//   scope = 'sidebar' (x=0,y=0) | 'canvas' (x!=0 or y!=0) | 'all' (par défaut)
...
// PUT générique (modifier code/nom/status/program/x/y)
