...
// Ouvrir modal Ajouter (seulement admin)
if(role === "admin"){
    ...
    addBtn.style.display = "none"; // cacher bouton pour user simple
}
...
// Drag déplacement canvas (admin seulement)
...
// Ajouter / Modifier (admin seulement)
if(role === "admin"){
